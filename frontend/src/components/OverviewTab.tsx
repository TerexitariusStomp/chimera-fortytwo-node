...
export default function OverviewTab({ contractKeys, txHistory, publicKeyStr, accountHash, balance }: {
  ...
  return (
    <div className="space-y-6">
      <div><h2 className="text-2xl font-bold">Overview</h2><p className="text-muted-foreground">Casper testnet contract dashboard</p></div>
      ...
      {publicKeyStr && (
        <Card className="p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <div><span className="text-muted-foreground">Balance:</span><div className="font-mono">{balance}</div></div>
          </div>
        </Card>
      )}
      <Card className="p-4">
